...
<body>
    <div class="row vh-100 p-0 m-0 col-12">
        <div class="col-2 p-0">
            <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark h-100">
                ...
                <li class="nav-item">
                    ...
                    <li>
                        <a href="listeCA.php" class="nav-link text-white active ">
                            Compte Avu
                        </a>
                    </li>
                    <li>
        ...
        <div class="col-10">
            ...
            <div class="mt-2">
                <form action="controller/rechercheCA.php" method="GET">
                ...
                <table class="table table-striped">
                    ...
                    if(isset($_GET['name']) && $_GET['name'] != ''){
                        $search = $_GET["name"];
                        $affichage = $select->query("SELECT * FROM utilisateur WHERE type= 'CA' AND nom='$search'");
                    }else{
                        $affichage = $select->query("SELECT * FROM utilisateur WHERE type= 'CA'");
                    }
                    ?>
